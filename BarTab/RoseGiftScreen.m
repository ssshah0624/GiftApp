...
{
    UIImageView* imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0,screenRect.size.height*0.49,screenRect.size.width, screenRect.size.height*0.57)];
...
{
    description = [[UILabel alloc]initWithFrame:CGRectMake(0,screenRect.size.height*0.53,screenRect.size.width, screenRect.size.height*0.1)];
    description.text = text;
    description.font = [UIFont fontWithName:@"HelveticaNeue-Medium" size:20.0f];
...
-(void)addTextView
{
    myTextView = [[UITextView alloc] initWithFrame:CGRectMake(0, screenRect.size.height*0.66, screenRect.size.width, screenRect.size.height*0.12)];
    ...
    characterCount = [[UILabel alloc]initWithFrame:CGRectMake(screenRect.size.width-50,screenRect.size.height*0.72,50, screenRect.size.height*0.1)];
...
-(void)addButtons
{
    ...
    button.frame = CGRectMake(screenRect.size.width * 0.5 - (300*0.5*0.5), screenRect.size.height*0.9, 300*0.5, 80*0.5);
    ...
    oneDoz.frame = CGRectMake(10,screenRect.size.height*0.78,100,60);
    ...
    twoDoz.frame = CGRectMake(screenRect.size.width*0.5-50,screenRect.size.height*0.78,100,60);
    ...
    threeDoz.frame = CGRectMake(screenRect.size.width-110,screenRect.size.height*0.78,100,60);
